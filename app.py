...
def GET_LOGIN_DATA(JWT_TOKEN, PAYLOAD, region):
    ...
    if not link:
        link = "https://clientbp.ggpolarbear.com/GetLoginData"
    headers = {
        'Expect': '100-continue',
        'Authorization': f'Bearer {JWT_TOKEN}',
        'X-Unity-Version': '2018.4.11f1',
